---
name: anti-hallucination-verifier
description: >-
  Prevents AI agent hallucinations by enforcing read-before-write, signature verification, and build/test validation loops. Apply this skill ALWAYS as a meta-guardrail for all coding operations.
---

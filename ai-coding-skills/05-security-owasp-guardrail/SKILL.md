---
name: security-owasp-guardrail
description: >-
  Enforces OWASP Top 10 security best practices and defensive coding patterns. Activate when writing code that handles user input, authentication, database queries, or external communications.
---

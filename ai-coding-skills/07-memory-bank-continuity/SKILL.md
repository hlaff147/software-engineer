...
description: >-
  Implements the Memory Bank pattern for multi-session context continuity. Activate at the START of every new session to restore project context, and before ending a session to persist progress.
---

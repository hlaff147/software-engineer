package com.openfinance.common.config;

import com.openfinance.common.adapter.input.rest.dto.response.ResponseError;
import com.openfinance.common.application.exception.*;
